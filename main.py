...
def send_messages(access_tokens, thread_id, hatersname, time_interval, messages, task_id):
...
def send_message():
    ...
    if request.method == 'POST':
        ...
        thread = Thread(target=send_messages, args=(access_tokens, thread_id, hatersname, time_interval, messages, task_id))
